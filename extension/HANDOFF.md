...
## Partially Complete
- Nothing partially complete yet — CP1 backend implementation begins next

## Currently In Progress
- CP1: Migration 013 + backend/src/extension.js

## Pending
- CP1: Migration 013 + backend extension module (7 routes + tests)
